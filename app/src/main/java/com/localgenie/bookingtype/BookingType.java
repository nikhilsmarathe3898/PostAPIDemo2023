...
public class BookingType extends DaggerAppCompatActivity implements BookingTypePresenter.viewPresenter, DialogTimeFragment.OnFragmentInteractionListener {
    ...
    TextView tvBookTypeSave;

    @BindView(R.id.tv_center)
    TextView tv_center;
    @BindView(R.id.toolBookingType)
    Toolbar toolBookingType;


    @BindView(R.id.glNowGrid)
    GridLayout glNowGrid;
    @BindView(R.id.glNowPartTimeGrid)
    GridLayout glNowPartTimeGrid;
    @BindView(R.id.tvNowSelTime)
    TextView tvNowSelTime;
    @BindView(R.id.tvNowTodaysTime)
    TextView tvNowTodaysTime;

    @BindView(R.id.ivNowCheck)
    ImageView ivNowCheck;
    @BindView(R.id.tvNow)
    TextView tvNow;
    @BindView(R.id.tvNowDesc)
    TextView tvNowDesc;
    @BindView(R.id.tvNowDecSelected)
    TextView tvNowDecSelected;
    @BindView(R.id.spaceNow)
    Space spaceNow;

    @BindView(R.id.glLaterGrid)
    GridLayout glLaterGrid;
    @BindView(R.id.ivLaterCheck)
    ImageView ivLaterCheck;
    @BindView(R.id.tvLater)
    TextView tvLater;
    @BindView(R.id.tvLaterDesc)
    TextView tvLaterDesc;

    @BindView(R.id.glRepeatGrid)
    GridLayout glRepeatGrid;
    @BindView(R.id.ivRepeatCheck)
    ImageView ivRepeatCheck;
    @BindView(R.id.tvRepeat)
    TextView tvRepeat;
    @BindView(R.id.tvRepeatDesc)
    TextView tvRepeatDesc;

    //Later Part
    @BindView(R.id.glLaterPartGrid)
    GridLayout glLaterPartGrid;
    @BindView(R.id.tvSelDate)
    TextView tvSelDate;
    @BindView(R.id.tvTodaysDate)
    TextView tvTodaysDate;

    @BindView(R.id.glLaterPartTimeGrid)
    GridLayout glLaterPartTimeGrid;
    @BindView(R.id.tvSelTime)
    TextView tvSelTime;
    @BindView(R.id.tvTodaysTime)
    TextView tvTodaysTime;

    @BindView(R.id.glLaterPartDurationGrid)
    GridLayout glLaterPartDurationGrid;
    @BindView(R.id.tvSelDuration)
    TextView tvSelDuration;
    @BindView(R.id.tvTodaysDuration)
    TextView tvTodaysDuration;

    //Repeat Part
    @BindView(R.id.glRepeatPartGrid)
    GridLayout glRepeatPartGrid;
    @BindView(R.id.tvSelRepeatStartDate)
    TextView tvSelRepeatStartDate;
    @BindView(R.id.tvTodaysRepeatStartDate)
    TextView tvTodaysRepeatStartDate;

    @BindView(R.id.glRepeatPartTimeGrid)
    GridLayout glRepeatPartTimeGrid;
    @BindView(R.id.tvRepeatSelTime)
    TextView tvRepeatSelTime;
    @BindView(R.id.tvRepeatStartTime)
    TextView tvRepeatStartTime;
    ...
    @BindView(R.id.glRepeatPartDurationGrid)
    GridLayout glRepeatPartDurationGrid;
    @BindView(R.id.tvSelRepeatDuration)
    TextView tvSelRepeatDuration;
    @BindView(R.id.tvSelRepeatDurationTime)
    TextView tvSelRepeatDurationTime;

    @BindView(R.id.glRepeatPartDaysGrid)
    GridLayout glRepeatPartDaysGrid;
    @BindView(R.id.tvSelRepeatDays)
    TextView tvSelRepeatDays;
    @BindView(R.id.tvTodaysRepeatDays)
    TextView tvTodaysRepeatDays;

    @BindView(R.id.rlMainBookingType)
    RelativeLayout rlMainBookingType;
    ...
    @BindView(R.id.tvEditShiftDetails)
    TextView tvEditShiftDetails;
    @BindView(R.id.llConfirmScheduledDays)
    LinearLayout llConfirmScheduledDays;

    @BindView(R.id.recyclerViewBookingType)
    RecyclerView recyclerViewBookingType;
     ...
     * Single shift
     **/
    @BindView(R.id.singleShiftBooking)
    LinearLayout singleShiftBooking;
    @BindView(R.id.tvConfirmSingleShift)
    TextView tvConfirmSingleShift;
    @BindView(R.id.tvEditSingleShiftDetails)
    TextView tvEditSingleShiftDetails;
    @BindView(R.id.tvSingleConfirmStartTime)
    TextView tvSingleConfirmStartTime;
    @BindView(R.id.tvSingleConfirmStartDate)
    TextView tvSingleConfirmStartDate;
    @BindView(R.id.tvSingleConfirmEndTime)
    TextView tvSingleConfirmEndTime;
    @BindView(R.id.tvSingleConfirmEndDate)
    TextView tvSingleConfirmEndDate;
    @BindView(R.id.tvSingleConfirmNumberOfHours)
    TextView tvSingleConfirmNumberOfHours;
    @BindView(R.id.llSingleConfirmScheduledDays)
    LinearLayout llSingleConfirmScheduledDays;
    /**
     *
     **/
    ...
    @OnClick({ // Date part time and duration //R.id.glLaterPartGrid,R.id.glLaterPartDurationGrid,R.id.glLaterPartTimeGrid,
            R.id.glNowPartTimeGrid, R.id.tvEditShiftDetails, R.id.tvEditSingleShiftDetails})
//R.id.glLaterPartTimeGrid,
    ...
    private void onViewSet(int i) {
        ...
        tvNowDesc.setSelected(false);
        tvLater.setSelected(false);
        tvLaterDesc.setSelected(false);
        tvRepeat.setSelected(false);
        tvRepeatDesc.setSelected(false);
        switch (i) {
            case 1:
    ...
    public void dateSelectionCancelled() {
        tvEditSingleShiftDetails.setText(getString(R.string.add));
    }
