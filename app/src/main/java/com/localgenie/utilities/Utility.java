...
public class Utility {
    ...
    public static void setAmtOnRecept(double amt, TextView textView, String currencySybmol,String text)
    {
        if(amt<=0)
        {
            if(Constants.paymentAbbr == 1)
    ...
    public static Bitmap setCreditCardLogo(String cardMethod, Context context) {
        ...
        switch (cardMethod) {
            ...
            case "Cash":
                ...
                break;
            case "Wallet":
                anImage = getBitmapFromVectorDrawable(context,R.drawable.ic_account_balance_wallet_black_24dp);
                break;
...
// meter
    ...
    public static View getCustomeBackgroundTextProfilePic(LayoutInflater inflater, String firstLetter, String secondLetter)
    {
