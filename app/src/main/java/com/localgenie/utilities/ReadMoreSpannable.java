...
/**
 * <h>ReadMoreSpannable</h>
 * Created by Ali on 9/20/2017.
 */

public class ReadMoreSpannable {
    //  private String readMore,readLess;
    private static String redMore, redLess;

    public ReadMoreSpannable(String readMore, String readLess) {
            ...
            ssb.setSpan(new MySpannable(false) {
                ...
                public void onClick(View widget) {
                    if (viewMore) {
                        ...
                        tv.invalidate();
                        makeTextViewResizable(tv, -1, redLess, false);
                    } else {
                        tv.setLayoutParams(tv.getLayoutParams());
                        tv.setText(tv.getTag().toString(), TextView.BufferType.SPANNABLE);
                        tv.invalidate();
                        makeTextViewResizable(tv, 3, redMore, true);
                    }
                }
