...
public class UploadAmazonS3
{
    ...
    public void Upload_data(final String bukkate_name, final File file, final Upload_CallBack callBack)
    {
        ...
        if(transferUtility!=null && file!=null)
        {
            ...
            observer.setTransferListener(new TransferListener()
            {
                ...
                public void onStateChanged(int id, TransferState state)
                {
                    ...
                    {
                        callBack.sucess("https://s3-ap-southeast-1.amazonaws.com/"+bukkate_name+"/"+file.getName());
        ...
        if(transferUtility!=null && file!=null)
        {
            ...
            observer.setTransferListener(new TransferListener()
            {
                ...
                public void onStateChanged(int id, TransferState state)
                {
                    ...
                    {
                        callBack.sucess("https://s3-ap-southeast-1.amazonaws.com/"+bukkate_name+"/"+fileName);
