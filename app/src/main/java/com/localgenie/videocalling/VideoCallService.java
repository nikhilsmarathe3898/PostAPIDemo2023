...
public class VideoCallService extends DaggerService implements AppRTCClient.SignalingEvents, PeerConnectionClient.PeerConnectionEvents, VideoCallEvents,
    ...
    private static final int MAX_RECONNECT_TIME = 90000;
    ...
    private boolean callControlFragmentVisible = true, cleanUpRequested;
    ...
    private boolean isMute = false, isVideoShow = false, timerAlreadyStarted, connected;
