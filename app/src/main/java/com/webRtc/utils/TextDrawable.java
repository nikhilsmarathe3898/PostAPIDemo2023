...
/**
 * Helper class to show the first letter of name of the designer/boutique in chat,recent activity,user profile,nearby boutiques in wallet,moda cash requests,claims and encashes
 */
