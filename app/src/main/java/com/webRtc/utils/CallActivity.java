...
//
//import com.webRtc.utils_try.AppRTCAudioManager.AudioDevice;
//import com.webRtc.utils_try.AppRTCAudioManager.AudioManagerEvents;
//import com.webRtc.utils_try.AppRTCClient.RoomConnectionParameters;
//import com.webRtc.utils_try.AppRTCClient.SignalingParameters;
//import com.webRtc.utils_try.PeerConnectionClient.DataChannelParameters;
//import com.webRtc.utils_try.PeerConnectionClient.PeerConnectionParameters;
//
...
//    private static final String TAG = "log1";//"CallRTCClient";
//
...
////    //Will try maximum 60 seconds for reconnection
...
//            Log.w(TAG, "Call is connected in closed or error state"+peerConnectionClient+" "+isError);
//          //  return;
//        }
...
//    private void onConnectedToRoomInternal(final SignalingParameters params, boolean reconnection) {
//        final long delta = System.currentTimeMillis() - callStartedTimeMs;
//
...
//            @Override
//            public void run() {
//                onConnectedToRoomInternal(params, false);
//            }
//        });
//    }
//
...
////                if (!reconnecting) {
//
////                    if (!isNetworkAvailable(CallActivity.this) || !isInternetAvailable()) {
////                        reconnecting = true;
////                        initializeTimerAndTimerTask();
////                        reconnectTimer.schedule(reconnectTimerTask, 0, 3000);
////                    }
//
////                }
//            }
...
//
//
//////For the network reconnect mode
////
...
//
//
////    private void initializeTimerAndTimerTask() {
////
////
...
////                            //    onConnectedToRoomInternal(signalingParameters, true);
////                            }
////
////
////                        }
