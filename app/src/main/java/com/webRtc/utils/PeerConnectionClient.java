...
//            Log.d(TAG, "Initialize WebRTC. Field trials: " + fieldTrials);
    ...
    public void createPeerConnection(final VideoSink localRender, final VideoSink remoteSink,
                                     final VideoCapturer videoCapturer, final SignalingParameters signalingParameters, boolean isVideoCall) {
...
//                videoWidth = VGA_VIDEO_WIDTH;
//                videoHeight =VGA_VIDEO_HEIGHT;
