...
import com.localgenie.videocalling.VideoCallContract;
import com.localgenie.videocalling.VideoCallEvents;
...
public class VideoCallSettings extends DaggerService implements AppRTCClient.SignalingEvents, PeerConnectionClient.PeerConnectionEvents, VideoCallEvents,
            ...
            if (intent != null) {
                ...
                try {
                    ...
                    if (!received) {
                        ...
                        mqttManager.publish(MqttEvents.Calls.value + "/" + intent.getExtras().getString("callerId"), obj, 1, false);
...
//        final long delta = System.currentTimeMillis() - callStartedTimeMs;
        Log.d(TAG, "onRemoteDescription: "+1);
        handler.post(new Runnable() {
            @Override
            public void run() {
                if (peerConnectionClient == null) {
    ...
    public void onRemoteIceCandidate(final IceCandidate candidate) {
        Log.d(TAG, "onRemoteIceCandidate: "+1);
        handler.post(new Runnable() {
            @Override
            public void run() {
                if (peerConnectionClient == null) {
    ...
    public void onLocalDescription(final SessionDescription sdp) {
        Log.d(TAG, "onLocalDescription: "+1);
 ...
 */
                        ...
                        mqttManager.publish(MqttEvents.Calls.value + "/" + extras.getString("callerId"), obj, 1, false);
        ...
        cancelCall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(intent != null) {
                    ...
                    presenter.endCall(intent.getExtras().getString("callerId"),"join",chatApiService);
                }
                else{
