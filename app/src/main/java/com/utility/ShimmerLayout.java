...
public class ShimmerLayout extends FrameLayout {
    ...
    private static final byte MIN_ANGLE_VALUE = -60;
    private static final byte MAX_ANGLE_VALUE = 60;
    ...
    public ShimmerLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            shimmerColor = a.getColor(R.styleable.ShimmerLayout_shimmer_color, getColor(R.color.shimmer_colors));
            autoStart = a.getBoolean(R.styleable.ShimmerLayout_shimmer_auto_start, false);
            maskWidth = a.getFloat(R.styleable.ShimmerLayout_shimmer_mask_width, 0.4F);
