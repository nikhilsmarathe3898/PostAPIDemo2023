...
/**
 * <h>DoubleDateTimePicker</h>
 * Created by Ali on 2/9/2018.
 */

public class DoubleDateTimePicker  extends LinearLayout {
    ...
    private SingleDateAndTimePicker.Listener listener;
    ...
    public DoubleDateTimePicker(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DoubleDateTimePicker(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private boolean isAfterMaxDate(Date date) {
        ...
        maxDateCalendar.setTimeZone(getTimeZone());
    ...
    public void setListener(SingleDateAndTimePicker.Listener listener) {
    ...
    private void updateListener() {
        ...
        SimpleDateFormat sdf = new SimpleDateFormat(format.toString(), Locale.getDefault());
        sdf.setTimeZone(timeZone);
        String display = sdf.format(date);
      //  String displayed = DateFormat.format(format, date).toString();
        if (listener != null) {
            listener.onDateChanged(display, date);
        }
    }
    ...
    public void setMustBeOnFuture(boolean mustBeOnFuture) {
        ...
        if (mustBeOnFuture) {
            ...
            minDate = Calendar.getInstance(getTimeZone()).getTime(); //minDate is Today
        }
    }
    ...
    public void setTimeZone(TimeZone timeZone)
    {
        ...
        Log.d("TimeZone ", "setTimeZone: "+timeZone);
    }

    public TimeZone getTimeZone()
    {
        Log.d("GETTIMEZONE", "getTimeZone: "+timeZone);
        return timeZone;
    }
