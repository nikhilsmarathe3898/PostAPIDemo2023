...
public class WheelDayPicker extends WheelPicker {
    ...
    public WheelDayPicker setDayFormatter(SimpleDateFormat simpleDateFormat){
        ...
        simpleDateFormat.setTimeZone(SingleDateTimeDialogReturn.timeZone);
        updateDays();
        return this;
    }
    ...
    private void updateDays() {
        ...
        instance.setTimeZone(SingleDateTimeDialogReturn.timeZone);
    ...
    private Date convertItemToDate(int itemPosition) {
        ...
        todayCalendar.setTimeZone(SingleDateTimeDialogReturn.timeZone);
        ...
        if (date != null) {
            ...
            dateCalendar.setTimeZone(SingleDateTimeDialogReturn.timeZone);
